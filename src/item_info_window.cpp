...
ItemInfoWindow::ItemInfoWindow(QWidget *parent)
    : QFrame(parent), title{new QLabel}, layout{new QVBoxLayout{this}},
      ...
      cancelEditButton(new QPushButton), goToItemButton{new QPushButton},
...
void ItemInfoWindow::initEditButtons() {
...
void ItemInfoWindow::handleItemUpdated() {
  if (hasChanges() && item) {
    Item::ItemData itemData = {
        ...
        editDescriptionLabel->toPlainText(), editTagsLabel->text().split(", "),
        item->favourite};
